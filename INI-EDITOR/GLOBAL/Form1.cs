    ...
    public partial class Form1 : Form
    {
        ...
        private void AddRowSafe(object row)
        {
            if (this.dataGridView1.InvokeRequired)
            {
                ...
                {
                    // Delegate my brother
                    this.dataGridView1.Invoke(new UpdateRowsDelegate(this.AddRowsSafe), row);
                }
                catch
                {
                }
            ...
            else
            {
                ...
                foreach (string RowsIni in rows)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        {
                            string box_msg = "Error happen on line, this line will be skiped:\n" + string.Join("|", lines);
                            string box_title = "Ini editor by davedevils";
        ...
        void Form1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            */
            string box_msg = "Sorry this fonction is not finished so i disabled it !";
            string box_title = "Ini editor by davedevils";
            MessageBox.Show(box_msg, box_title);
        }
        ...
        private void OpenIniFile()
        {
            ...
            this.openFileDialog1.Title = "Find Ini file";
            ...
            if (ininode_files == System.Windows.Forms.DialogResult.OK)
            {
                ...
                //System.IO.StreamReader file = new System.IO.StreamReader(openFileDialog1.FileName, big5, true);
                //Now Read line by Line

                int lignenumber = 1;
                ListOfRow = new List<string>();

                List<string> filedata = BasicFunc.TrimFileList(openFileDialog1.FileName, true);
                ...
                for (int z = 0; z < filedata.Count ;z++)
                {
                    ...
                    {
                        string boxmsg = "This file is not a valid Xlegend ini file. \nSorry i will not open it!";
                    ...
                    else if (lignenumber == 1)
                    {
                        ...
                        foreach (FileInfo FileListed in Files)
                        {
                            ...
                            if(extractedname.Replace(".col", "").ToLower() == safefilename.Replace(".ini", "").ToLower())
                            {
                                ...
                                int ColNumber = Int32.Parse(returndata[2]);
        ...
        private void saveFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string text = File.ReadAllText(outputfilename, big5);
            text = text.Replace("/r/n", "\r\n");
            File.WriteAllText(outputfilename, text, big5);
        ...
        {
            string box_msg = "This program is created for edit ini for more info/edit/fix\nYou can contact me on discord \nDave Devil's#9555";
            string box_title = "Ini editor by davedevils";
            MessageBox.Show(box_msg, box_title);
        }
